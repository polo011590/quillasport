...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Registro de Arbitros</title>
    ...
    <body>
        ...
        <div style="width: 90%; margin: 0px auto; margin-top: 30px;">
            <fieldset>
                <legend style="color: #339900;">Registro de Arbitros</legend>
                <form id="formreg" action="process.php?c=1" method="post">
                    ...
                    $model->Get_Usuarios();
                    ?>
                    <label>C&eacute;dula: </label><input list="usuarios" required autocomplete="off" style="width: 100%;" type="text" name="cedula">
